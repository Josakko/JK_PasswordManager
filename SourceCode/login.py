...
class Login(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        tk.Label(self, text="Enter your password", font=("arial", 13),
                 fg="white", bg="#3d3d5c").pack(pady=10)
        ...
        enter_button = tk.Button(self, text="Login", font=("arial", 13),
        ...
        incorrect_password_label = tk.Label(forget_pass_signup_button_frame, text='', font=("arial", 13),
        ...
        def new_user_sign_up():
            ...
            tk.Label(pop, text="Enter your username", font=("arial", 13),
                     fg="white", bg="#3d3d5c").pack(pady=10)
            ...
            register_button = tk.Button(pop, text="Register", font=("arial", 13),
                                        relief="raised", command=register,
                                        borderwidth=3, height=2, width=15)
            register_button.pack(pady=20)

            incorrect_info_label = tk.Label(pop, text='', font=("arial", 13),
